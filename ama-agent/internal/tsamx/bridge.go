...
// never exec the real CLI. The exec implementation injects a per-account
...
type AddRequest struct {
	Email          string
	CredentialJSON []byte
	ConfigDir      string // CLAUDE_CONFIG_DIR for this account (optional isolation)
	DataHome       string // XDG_DATA_HOME for this account (optional isolation)
