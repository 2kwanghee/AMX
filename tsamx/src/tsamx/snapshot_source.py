...
every few seconds and a one-shot ``tsamx list`` produce identical network
behavior. This class therefore just runs the same on-demand pass as ``tsamx
...
from tsamx.json_output import USAGE_TOKEN_EXPIRED
