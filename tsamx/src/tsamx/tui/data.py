...
``tsamx.snapshot_source.SnapshotSource`` (shared with any GUI shell);
...
from tsamx import oauth, printer, usage_store
from tsamx.exceptions import ClaudeSwitchError
from tsamx.snapshot_source import SnapshotSource
from tsamx.switcher import SENTINEL_NOTES, last_seen_note
...
def sentinel_label(sentinel: str) -> str:
    """The same wording ``tsamx list`` prints for this sentinel state."""
