...
from tsamx import printer
from tsamx.models import AccountsSnapshot
from tsamx.snapshot_source import account_identity
from tsamx.settings import load_settings, load_ui_settings, set_setting
...
from tsamx.tui.data import ActionResult, SnapshotSource, format_duration, run_action
from tsamx.tui.modals import AddTokenModal, ConfirmModal, OutputModal, TokenForm
from tsamx.tui.theme import TSAMX_DARK, TSAMX_LIGHT


class TsamxApp(App):
    """tsamx interactive dashboard."""
    ...
    def __init__(
        ...
        *,
        ...
        self._start = start  # "dashboard" | "watch" (`tsamx watch`)
