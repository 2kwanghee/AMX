...
from tsamx.json_output import USAGE_API_KEY
from tsamx.models import AccountSnapshot
from tsamx.usage_store import STALE_OK_S
...
def account_card_text(
    ...
    *,
    ...
    if sentinel is not None:
        ...
        # Same supplementary line `tsamx list` prints: the last good
...
class AccountsPanel(Static):
    ...
    def render(self) -> Text:
        app: "TsamxApp" = self.app  # type: ignore[assignment]
