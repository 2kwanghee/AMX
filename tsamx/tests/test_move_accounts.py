"""Tests for `tsamx move` (ClaudeAccountSwitcher.move_account)."""
...
class TestMoveAccount:
    ...
    def test_move_holds_account_lock(
        ...
        monkeypatch.setattr("tsamx.switcher.FileLock", SpyLock)
        switcher.move_account("2", "5")
    ...
    def test_move_strict_clear_fails_closed_on_locked_keychain(
        ...
        from tsamx.credentials import SECURITY_SERVICE
